        ...
        <div className="flex flex-col h-full overflow-y-auto">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 flex-shrink-0">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-primary-green text-white rounded-lg flex items-center justify-center font-bold text-xl">
                C
              </div>
              <span className="text-xl font-semibold text-gray-800">Cactus</span>
            </div>
            <button
